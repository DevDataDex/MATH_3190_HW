...
I added a table of all of the games played by the team of interest to get a better visual of the game by game break down. Since there can be a lot of rows, I limited it to 10 rows at a time. In its first form the table was a copy of the KenPom data. Two of the principles of good visualization is that it is easier to compare columns than rows, and objects being compared should be side by side. I changed my table so each row represented a game and the two scores were placed next to eachother in the table. 
